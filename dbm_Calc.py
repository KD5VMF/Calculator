...
class Converter(tk.Tk):
    def __init__(self):
        ...
        self.formula_label = tk.Label(self, text="Formula: ")
        self.formula_label.grid(row=3, column=0, columnspan=4)
    ...
    def show_about(self):
        ...
        #about_label = tk.Label(about_window, text="Advanced dB, dBm and Watts Converter\n\nThis application allows conversion between dB, dBm and Watts.\nSelect the unit of the value you want to convert from and the unit you want to convert to.\nInput the value and click 'Calculate' to get the result.\nClick 'Clear' to reset the input field and result.")
